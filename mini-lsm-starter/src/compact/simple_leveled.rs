...
impl SimpleLeveledCompactionController {
    ...
    pub fn generate_compaction_task(
        ...
        // check level0_file_num_compaction_trigger for compaction L0 to L1.
        if snapshot.l0_sstables.len() >= self.options.level0_file_num_compaction_trigger {
            println!(
                "compaction triggered at level0 because L0 has {} SSTs >= {}",
        ...
        // check size_ratio_percent for compaction of other level (>=1)
